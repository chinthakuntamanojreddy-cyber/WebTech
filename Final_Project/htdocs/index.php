...
<head>
  ...
  <title>Vechile Management</title>
  <style>
    body {
      font-family: 'Segoe UI', Tahoma, Geneva, Verdana, sans-serif;
      background-image: linear-gradient(rgba(0, 0, 0, 0.5), rgba(0, 0, 0, 0.5)), url('Vechiles/BG5.jpg'); /* Replace with your actual image path */
...
<div class="top-bar d-flex justify-content-between align-items-center p-3 border-bottom" style="background: transparent; font-family: 'Cinzel', serif;">
  ...
  <a href="/Vechiles/Auto.php" class="btn btn-info btn-md shadow  px-4 py-2">
    <i class="fas fa-car fa-sm text-white-50"></i> Auto Details
  </a>
  <a href="edit_dropdowns.html" class="btn btn-success btn-md shadow px-4 py-2">
...
<!-- Form Container with Normal Font -->
<div class="form-container">
<h1 style="font-family: 'Cinzel', serif;">Bus Details</h1>
  <form action="store_bus_entry.php" method="POST">
    <div class="form-grid">
